...
const sspSchema = {
  ...
  "definitions": {
        ...
        "status": {
          ...
          "properties": {
            "state": {
              ...
              "type": "string",
              "enum": ["under_development", "operational", "disposition", "other"]
            },
            "remarks": {
              "$ref": "#/definitions/remarks"
            }
    ...
    "authorized_privilege": {
      ...
      "required": ["title", "functions_performed"],
      "additionalProperties": false
    },
    "function_performed": {
    ...
    "system_security_plan": {
      ...
      "required": ["uuid", "metadata", "import_profile", "system_characteristics", "system_implementation", "control_implementation"],
      "additionalProperties": false
    },
    "import_profile": {
    ...
    "system_characteristics": {
        ...
        "status": {
          ...
          "properties": {
            "state": {
              ...
              "type": "string",
              "enum": ["operational", "under_development", "under_major_modification", "disposition", "other"]
            },
            "remarks": {
              "$ref": "#/definitions/remarks"
            }
      ...
      "required": ["system_ids", "system_name", "description", "security_sensitivity_level", "system_information", "security_impact_level", "status", "authorization_boundary"],
      "additionalProperties": false
    },
    "system_information": {
      ...
      "properties": {
        ...
        "information_types": {
          ...
          "items": {
            ...
            "required": ["title", "description", "confidentiality_impact", "integrity_impact", "availability_impact"],
            "additionalProperties": false
          }
        }
      },
      "required": ["information_types"],
      "additionalProperties": false
    },
    "security_impact_level": {
      ...
      "required": ["security_objective_confidentiality", "security_objective_integrity", "security_objective_availability"],
      "additionalProperties": false
    },
    "authorization_boundary": {
      ...
      "properties": {
        ...
        "leveraged_authorizations": {
          ...
          "items": {
            ...
            "required": ["uuid", "title", "party_uuid", "date_authorized"],
            "additionalProperties": false
          }
        },
        "users": {
    ...
    "control_implementation": {
      ...
      "required": ["description", "implemented_requirements"],
      "additionalProperties": false
    },

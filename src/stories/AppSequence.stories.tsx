        ...
        elements: [
            ...
            },
            {
                ...
                component: ({ onStatusChange }) => {
                    ...
                    return <><AppInput onInputChange={(text) => { onStatusChange(text.length === 0 ? "locked" : "valid") }} placeholder="Threat" /></>
                },
            },
            {
                ...
                component: ({ onStatusChange }) => {
                    ...
                    return <><AppInput onInputChange={(text) => { onStatusChange(text.length === 0 ? "locked" : "valid") }} placeholder="Values" /></>
                },
            }
        ],
